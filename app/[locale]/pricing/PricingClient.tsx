      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
        ...
        <div className="border border-border-subtle bg-surface rounded-2xl p-8 flex flex-col h-full">
          ...
          <ul className="space-y-4 mb-8 flex-1 text-sm text-text-secondary">
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 월 3회 AI 포스트 생성
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 단일 GitHub 저장소 연동
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 기본 마크다운 스타일
            </li>
            <li className="flex gap-3">
              <span className="text-text-tertiary">✓</span>{" "}
              <span className="opacity-70">Synapso.dev 워터마크 포함</span>
            </li>
          </ul>
          <button
            disabled
        ...
        <div className="border-2 border-accent bg-surface rounded-2xl p-8 flex flex-col h-full relative transform md:-translate-y-4 shadow-2xl shadow-accent/5">
          ...
          <ul className="space-y-4 mb-8 flex-1 text-sm text-text-primary">
            <li className="flex gap-3">
              <span className="text-accent">✓</span> <strong>월 30회</strong> AI
              포스트 생성
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span>{" "}
              <strong>Gemini 1.5 Pro</strong> 고급 분석 모델 적용
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span>{" "}
              <strong>워터마크 완벽 제거</strong>
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> SEO 메타 데이터 자동 최적화
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 특정 기술 블로그 문체
              커스텀
            </li>
          </ul>
          <button
        ...
        <div className="border border-border-subtle bg-surface rounded-2xl p-8 flex flex-col h-full">
          ...
          <ul className="space-y-4 mb-8 flex-1 text-sm text-text-secondary">
            <li className="flex gap-3">
              <span className="text-accent">✓</span> <strong>무제한</strong>{" "}
              포스트 생성
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 팀원 계정 통합 및 공동 편집
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> 기업 고유 브랜드 보이스
              학습
            </li>
            <li className="flex gap-3">
              <span className="text-accent">✓</span> Notion, Velog 자동 퍼블리싱
            </li>
          </ul>
          <button
