    ...
    <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 animate-fade-in-up">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-lg text-text-secondary">
          코드만 작성하세요. 커밋 내역을 분석해 전문적인 기술 블로그 포스트로
          변환해 드립니다.
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="p-6 border border-border-subtle rounded-xl bg-surface">
            <h4 className="font-semibold text-lg mb-2">
              생성된 글의 저작권은 누구에게 있나요?
            </h4>
            <p className="text-text-secondary">
              결과물에 대한 모든 지적 재산권(저작권 등)은 원천 데이터(커밋 및
              코드)를 제공한 사용자에게 100% 귀속됩니다. Synapso.dev는 여러분의
              코드를 AI 학습 모델에 사용하지 않으며, 작업 완료 후 즉시
              파기합니다.
            </p>
          </div>
          <div className="p-6 border border-border-subtle rounded-xl bg-surface">
            ...
            <p className="text-text-secondary">
              네, Basic(무료) 플랜은 월 3회 AI 포스트 생성을 평생 무료로
              지원합니다. 더 전문적이고 긴 분석이 필요하다면 Pro 플랜으로
              업그레이드하세요.
            </p>
          </div>
        </div>
