...
export function generateMetadata({params}: {params: {locale: string}}): Metadata {
  ...
  return {
    ...
    title: {
      default: isEn ? "AI Tech Blog | Development & Automation Insights" : "AI Tech Blog | 개발 및 자동화 인사이트",
      template: "%s"
    },
    description: isEn 
    ...
    keywords: ["Tech Blog", "Developer", "AI", "Automation", "Software Engineering", "Next.js", "Retrospective", "Code Analysis"],
    creator: "AI Tech Blogger",
    openGraph: {
      title: isEn ? "AI Tech Blog | Development & Automation Insights" : "AI Tech Blog | 개발 및 자동화 인사이트",
      description: isEn
        ? "Expert tech blog focusing on AI-powered code analysis, tech trends, automation architecture, and software engineering insights."
        : "AI 기반 코드 분석, 기술 트렌드, 자동화 아키텍처 및 소프트웨어 엔지니어링 인사이트를 다루는 전문가의 기술 블로그입니다.",
      type: "website",
    ...
    twitter: {
      ...
      title: isEn ? "AI Tech Blog | Development & Automation Insights" : "AI Tech Blog | 개발 및 자동화 인사이트",
      description: isEn ? "AI-powered tech and code insight automation blog." : "AI 기반 기술 및 코드 인사이트 자동화 블로그.",
    },
    robots: {
      index: true,
      follow: true,
